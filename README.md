...
- **[Quick Start SSG](QUICK-START-SSG.md)** - Generate static pages in 3 steps
- **[SSG Setup Guide](SETUP-SSG.md)** - Detailed setup instructions
- **[SSG Technical Guide](SSG-README.md)** - Advanced SSG documentation
...
See [QUICK-START-SSG.md](QUICK-START-SSG.md) for details.
...
npm run build:ssg
```
Generates static HTML for all pages. See [SSG docs](QUICK-START-SSG.md).
...
See [Quick Start SSG Guide](QUICK-START-SSG.md) for details.
