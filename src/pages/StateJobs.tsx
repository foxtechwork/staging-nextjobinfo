...
export default function StateJobs() {
  ...
  return (
    <>
      <Helmet>
        <title>{stateName} Govt Jobs 2025 - Latest Sarkari Naukri | NextJobInfo</title>
        <meta 
          name="description" 
          content={`Find latest ${stateName} government jobs 2025. Apply for ${stateName} sarkari naukri, state govt vacancies, exam notifications. Updated daily with ${filteredJobs.length}+ active jobs.`}
        />
        <meta 
          name="keywords" 
          content={`${stateName} government jobs 2025, ${stateName} sarkari naukri, ${stateName} govt vacancy, ${stateName} state jobs, ${stateName} recruitment 2025, ${stateName} exam alerts, latest ${stateName} jobs`}
        />
        ...
        <meta property="og:image:secure_url" content="https://staging-nextjobinfo.pages.dev/share-jobs-with-nextjobinfo.png" />
          ...
          {JSON.stringify({
            ...
            "mainEntity": {
              ...
              "itemListElement": filteredJobs.slice(0, 10).map((job, index) => ({
                ...
                "hiringOrganization": {
                  "@type": "Organization",
                  "name": job.recruitment_board || stateName + " Government"
                },
                "jobLocation": {
                  "@type": "Place",
                  "address": {
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-foreground mb-2">
            {stateName} Govt Jobs 2025 - Latest Sarkari Naukri
          </h1>
          <h2 className="text-base sm:text-lg text-muted-foreground mb-6">
            Find {filteredJobs.length}+ latest government job opportunities in {stateName} | Updated Daily
          </h2>
