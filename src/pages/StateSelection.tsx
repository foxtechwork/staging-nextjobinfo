...
export default function StateSelection() {
  ...
  const enrichedStates = indianStates.map(state => {
    ...
    // If state has 0 vacancies, show All India jobs count instead
    const displayVacancies = vacancies === 0 && jobStats?.allIndiaVacancies 
      ? jobStats.allIndiaVacancies 
      : vacancies;
    return {
      ...state,
      jobCount: displayVacancies,
    };
  });
