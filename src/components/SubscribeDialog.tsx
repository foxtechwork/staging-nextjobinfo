        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4 mt-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor="subscribe-name" className="text-sm">Name</FormLabel>
                  <FormControl>
                    <Input 
                      id="subscribe-name"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor="subscribe-email" className="text-sm">Email</FormLabel>
                  <FormControl>
                    <Input 
                      id="subscribe-email"
                      type="email" 
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor="subscribe-whatsapp" className="text-sm">WhatsApp Number</FormLabel>
                  <FormControl>
                    <Input 
