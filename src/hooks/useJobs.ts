  ...
  let filteredData = data.filter(job => {
        ...
        const matchesCategory = !filters.category || filters.category === "All India Govt Jobs" ||
          ...
          (filters.category === "Railway Jobs" && (
            ...
            arrayIncludes(job.job_type_tags, "railway") ||
            arrayIncludes(job.job_area_tags, "railway") ||
            arrayIncludes(job.job_area_tags, "metro")
          )) ||
          (filters.category === "Teaching Jobs" && (
            ...
            arrayIncludes(job.post_position_tags, "professor") ||
            arrayIncludes(job.job_area_tags, "education")
          )) ||
          (filters.category === "Engineering Jobs" && (
            ...
            arrayIncludes(job.post_position_tags, "engineer") ||
            arrayIncludes(job.education_tags, "engineering")
          )) ||
          (filters.category === "Police/Defence Jobs" && (
            ...
            arrayIncludes(job.job_type_tags, "police") ||
            arrayIncludes(job.job_type_tags, "defence") ||
            arrayIncludes(job.job_type_tags, "army") ||
            arrayIncludes(job.job_area_tags, "defence")
          ));
